#ifndef __YUNI_TOOLBOX_PREPROCESSOR_CAPABILITIES_UNIXES_H__
# define __YUNI_TOOLBOX_PREPROCESSOR_CAPABILITIES_UNIXES_H__
...
#endif // __YUNI_TOOLBOX_PREPROCESSOR_CAPABILITIES_UNIXES_H__
