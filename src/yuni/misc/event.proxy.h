#ifndef __YUNI_MISC_EVENT_PROXY_H__
# define __YUNI_MISC_EVENT_PROXY_H__
...
namespace Proxy
{
	...
	*/
	...
	{
	public:
		typedef typename Event::E1<T1> EventType;
	public:
		P1() : pProxy(NULL) {}
	...
	*/
	...
	{
	public:
		typedef typename Event::E2<T1, T2> EventType;
	public:
		P2() : pProxy(NULL) {}
	...
	*/
	...
	{
	public:
		typedef typename Event::E3<T1, T2, T3> EventType;
	public:
		P3() : pProxy(NULL) {}
	...
	*/
	...
	{
	public:
		typedef typename Event::E4<T1, T2, T3, T4> EventType;
	public:
		P4() : pProxy(NULL) {}
		...
		{if (pProxy) (*pProxy)(a1, a2, a3, a4, em);}
	...
	*/
	...
	{
	public:
		typedef typename Event::E5<T1, T2, T3, T4, T5> EventType;
	public:
		P5() : pProxy(NULL) {}
		...
		{if (pProxy) (*pProxy)(a1, a2, a3, a4, a5, em);}
	...
	*/
	...
	{
	public:
		typedef typename Event::E6<T1, T2, T3, T4, T5, T6> EventType;
	public:
		P6() : pProxy(NULL) {}
		...
		{if (pProxy) (*pProxy)(a1, a2, a3, a4, a5, a6, em);}
	...
	*/
	...
	{
	public:
		typedef typename Event::E7<T1, T2, T3, T4, T5, T6, T7> EventType;
	public:
		P7() : pProxy(NULL) {}
		...
		{if (pProxy) (*pProxy)(a1, a2, a3, a4, a5, a6, a7, em);}
	...
	*/
	...
	{
	public:
		typedef typename Event::E8<T1, T2, T3, T4, T5, T6, T7, T8> EventType;
	public:
		P8() : pProxy(NULL) {}
		...
		{if (pProxy) (*pProxy)(a1, a2, a3, a4, a5, a6, a7, a8, em);}
...
#endif // __YUNI_MISC_EVENT_PROXY_H__
