#ifndef __YUNI_TOOLBOX_LOGS_DECORATORS_APPLICATION_NAME_H__
# define __YUNI_TOOLBOX_LOGS_DECORATORS_APPLICATION_NAME_H__
...
#endif // __YUNI_TOOLBOX_LOGS_DECORATORS_APPLICATION_NAME_H__
