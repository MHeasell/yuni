#ifndef __YUNI_TOOLBOX_LOGS_DECORATORS_VERBOSITY_LEVEL_H__
# define __YUNI_TOOLBOX_LOGS_DECORATORS_VERBOSITY_LEVEL_H__
...
#endif // __YUNI_TOOLBOX_LOGS_DECORATORS_VERBOSITY_LEVEL_H__
