...
int main(void)
{
	...
	Gfx::Color::RGBA<uint8> b_red(   255, 0,   0,   255);
	Gfx::Color::RGBA<uint8> b_green( 0,   255, 0); // By default, a color is opaque
	...
	Gfx::Color::RGBA<float> f_red(   1.0f,  0.0f, 0.0f, 1.0f);
	Gfx::Color::RGBA<float> f_green( 0.0f,  1.0f, 0.0f); // By default, a color is opaque
